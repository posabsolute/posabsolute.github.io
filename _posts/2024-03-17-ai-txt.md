...
Two years later, most of this happened, just not under this name. Six months after this post, Jeremy Howard proposed [llms.txt](https://llmstxt.org/) (September 2024), which standardized the reading half of the idea: a file that tells models what matters on your site. Two months after that, Anthropic released the [Model Context Protocol](https://modelcontextprotocol.io/), which standardized the acting half: how an agent calls a site's capabilities. Together they cover most of what I sketched here.

What still does not exist is the policy layer: a site declaring what agents may do, which actions are irreversible, and which parts of a page are user-generated content that should never be treated as instructions. My bet is that lands inside the MCP ecosystem as a discovery convention rather than as a standalone file. Being six months early with the right question and zero adoption is a very normal way to be right on the internet. I will take it.
